...
| 04 | LLM01 | 웹검색(SearXNG) 경유 간접 인젝션 | ⬜ |
| 05 | LLM05 | 마크다운 이미지 데이터 유출 | ⬜ |
| 06 | LLM06 | 과도한 에이전시 / 툴 오남용 | ⬜ |
| 07 | LLM04 | 지식베이스 포이즈닝 | ⬜ |
| 08 | LLM08 | 임베딩 / 검색 조작 | ⬜ |
| 09 | LLM02 | 크로스 세션 정보 유출 | ⬜ |
| 10 | LLM10 | 무제한 소비 / Denial-of-Wallet | ⬜ |
| 11 | LLM01/04 | **메모리 = 간접 인젝션 영속화** (시나리오 2에서 발견) | ⬜ 백로그 |
| 12 | LLM01 | task 모델(제목/태그 생성) 경유 인젝션 (시나리오 2에서 발견) | ⬜ 백로그 |
